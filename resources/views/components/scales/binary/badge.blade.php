...
@php
    ...
    $colorClass = match ($grade) {
		\App\Services\Scorers\Scales\BinaryScale::IRRELEVANT => 'bg-red-500 dark:bg-red-600 text-white',
		\App\Services\Scorers\Scales\BinaryScale::RELEVANT => 'bg-green-500 dark:bg-green-600 text-white',
