	...
	<nav class="bg-white border-gray-200 py-2.5 dark:bg-gray-900">
		<div class="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto gap-y-2">
			...
			<div class="flex items-center lg:order-2">
				...
				@else
				<!-- Log In -->
				<a href="{{ route('login') }}" class="ml-2 text-white bg-indigo-600 hover:bg-indigo-700 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 sm:mr-2 lg:mr-0 focus:outline-none">
					Log In
				</a>
				@endif
