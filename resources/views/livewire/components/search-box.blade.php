<div class="relative" x-data="{ query: @entangle('query') }">
	...
	/>
	<div x-show="query" class="absolute inset-y-0 right-0 flex items-center pr-3 pt-0.5">
		<button type="button" @click="query = ''" class="focus:outline-none text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200">
